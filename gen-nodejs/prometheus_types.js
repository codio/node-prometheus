...
var GetCourseResult = module.exports.GetCourseResult = function(args) {
  this.courses = null;
  this.modules = null;
  if (args) {
    if (args.courses !== undefined && args.courses !== null) {
      this.courses = Thrift.copyList(args.courses, [course_ttypes.Course]);
    } else {
    ...
    if (args.modules !== undefined && args.modules !== null) {
      this.modules = Thrift.copyMap(args.modules, [module_ttypes.Module]);
    }
  }
};
...
var UpdateCourseDetails = module.exports.UpdateCourseDetails = function(args) {
  this.name = null;
...
var UpdateModuleDetails = module.exports.UpdateModuleDetails = function(args) {
  this.name = null;
  this.description = null;
  this.longDescription = null;
  this.imageUrl = null;
...
var UpdateUnitDetails = module.exports.UpdateUnitDetails = function(args) {
  this.name = null;
  this.description = null;
  this.imageUrl = null;
  if (args) {
...
var ChangeStackVersionInUnitResult = module.exports.ChangeStackVersionInUnitResult = function(args) {
  this.unitVersion = null;
  if (args) {
    if (args.unitVersion !== undefined && args.unitVersion !== null) {
      this.unitVersion = new unit_ttypes.Version(args.unitVersion);
    }
  }
};
...
var ReorderConflictException = module.exports.ReorderConflictException = function(args) {
  ...
  if (args) {
    if (args.currentModule !== undefined && args.currentModule !== null) {
      this.currentModule = new module_ttypes.Module(args.currentModule);
    } else {
...
var NoGuidesInUnitException = module.exports.NoGuidesInUnitException = function(args) {
...
var AssessmentAlreadyAnsweredException = module.exports.AssessmentAlreadyAnsweredException = function(args) {
