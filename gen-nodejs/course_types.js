...
CourseInfo = module.exports.CourseInfo = function(args) {
  this.id = null;
  this.name = null;
  if (args) {
    if (args.id !== undefined) {
...
CourseInfo.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
CourseInfo.prototype.write = function(output) {
  output.writeStructBegin('CourseInfo');
  if (this.id !== null && this.id !== undefined) {
    output.writeFieldBegin('id', Thrift.Type.STRING, 1);
    output.writeString(this.id);
    output.writeFieldEnd();
